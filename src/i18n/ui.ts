...
export const ui = {
  fr: {
    ...
    "sponsors.cta.body":
      "Associez votre entreprise à l'événement cloud-native francophone de référence et profitez d'une visibilité forte auprès d'un écosystème engagé de décideurs, d'experts, et de leaders technologiques.",
    ...
    "schedule.download_pdf": "Tout le programme {year}",
    ...
    "team.group.core.body": "Ils œuvrent toute l'année pour vous organiser Cloud Native Days France.",
    "team.group.program_committee": "Comité de programme",
    "team.group.program_committee.body": "Ils notent les nombreuses propositions de conférences et aident à l'établissement de la programmation.",
    "team.group.volunteers": "Autres bénévoles",
    "team.group.volunteers.body": "Ils nous aident le jour J, épaulés par de nombreux étudiants de nos écoles partenaires.",
    ...
    "contact.lead": "Toute l'équipe de bénévoles organisateurs est mobilisée et à votre disposition pour répondre à vos questions. Envoyez-nous un mail à l'adresse qui correspond à votre demande.",
  ...
  en: {
    ...
    "speakers.regular_rail_label": "Conferences",
    "speakers.keynote_badge": "Keynote",
    ...
    "schedule.download_pdf": "Download {year} programme",
    ...
    "team.group.core.body": "They work all year long to organize Cloud Native Days France for you.",
    "team.group.program_committee": "Program Committee",
    "team.group.program_committee.body": "They review the many talk proposals and help shape the programme.",
    "team.group.volunteers": "Other volunteers",
    "team.group.volunteers.body": "They support us on the day, alongside students from our partner schools.",
