...
export const ui = {
  fr: {
    ...
    "discover.audience.dev.topics": "CI/CD · Developer Experience · Observabilité · IA applicative",
    "discover.audience.cloud.title": "Ingénieur·e Cloud & DevOps",
    "discover.audience.cloud.topics": "Kubernetes · GitOps · IaC · FinOps · DevSecOps",
    "discover.audience.ops.title": "Ops & SRE",
    "discover.audience.ops.topics": "Infrastructure · Réseau · Sécurité · Fiabilité",
    "discover.audience.lead.title": "Tech Lead & Architecte",
    "discover.audience.lead.topics": "Architecture cloud · Gouvernance · Stratégie technique",
    "discover.audience.cto.title": "CTO, DSI & VP…",
    "discover.audience.cto.topics": "ROI cloud · Tendances · Transformation IT",
  ...
  en: {
    ...
    "discover.audience.dev.topics": "CI/CD · Developer Experience · Observability · Applied AI",
    "discover.audience.cloud.title": "Cloud & DevOps Engineer",
    "discover.audience.cloud.topics": "Kubernetes · GitOps · IaC · FinOps · DevSecOps",
    "discover.audience.ops.title": "Ops & SRE",
    "discover.audience.ops.topics": "Infrastructure · Networking · Security · Reliability",
    "discover.audience.lead.title": "Tech Lead & Architect",
    "discover.audience.lead.topics": "Cloud architecture · Governance · Technical strategy",
    "discover.audience.cto.title": "CTO, CIO & VP…",
    "discover.audience.cto.topics": "Cloud ROI · Trends · IT transformation",
