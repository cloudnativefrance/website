...
export const ui = {
  fr: {
    ...
    "nav.programme.submenu.programme": "Programme 2026",
    ...
    "tickets.coming_soon.body": "Inscrivez-vous à la newsletter pour être informé·e dès l'ouverture des inscriptions.",
    "tickets.coming_soon.cta": "Rejoindre la newsletter",
    ...
    "sponsors.cta.body":
      "Associez votre entreprise à l'événement cloud-native francophone de référence et profitez d'une visibilité forte auprès d'un écosystème engagé de décideurs, d'experts, et de leaders technologiques. C'est aussi l'occasion de valoriser vos solutions, de développer vos opportunités business et de renforcer votre marque employeur.",
    ...
    "schedule.notice.2027_coming": "Le programme 2027 est en cours de préparation. En attendant, retrouvez tous les talks 2026 sur YouTube !",
    "schedule.notice.watch_playlist": "Voir la playlist YouTube 2026",
  ...
  en: {
    ...
    "about.subnav.heading": "Also discover",
    ...
    "tickets.coming_soon.body": "Subscribe to the newsletter to be notified the moment registrations open.",
    "tickets.coming_soon.cta": "Join the newsletter",
    "site.title": "Cloud Native Days France 2027",
    ...
    "sponsors.cta.body":
      "Align your company with the leading French-speaking cloud-native event and gain strong visibility with an engaged ecosystem of decision-makers, experts, and technology leaders. It's also an opportunity to showcase your solutions, develop new business opportunities, and strengthen your employer brand.",
    ...
    "schedule.notice.2027_coming": "The 2027 programme is coming soon. In the meantime, watch all the 2026 talks on YouTube!",
    "schedule.notice.watch_playlist": "Watch 2026 YouTube playlist",
    ...
    "footer.association": "Organized as a French loi 1901 non-profit, by the Cloud Native France association.",
    "footer.nav.heading": "Navigation",
