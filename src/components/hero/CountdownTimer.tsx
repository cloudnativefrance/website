...
import { getReplaysPath, TARGET_DATE } from "@/lib/event";
    ...
    return (
      <div className="flex flex-col items-center gap-4">
        ...
        <a
          ...
          className="inline-flex h-[52px] items-center justify-center rounded-lg bg-primary px-8 text-lg font-bold text-primary-foreground shadow-[var(--shadow-glow-primary)] transition-[background-color,translate] duration-150 hover:translate-y-[-1px] hover:bg-primary/90"
        >
          {t("hero.cta.replays")}
        </a>
      </div>
