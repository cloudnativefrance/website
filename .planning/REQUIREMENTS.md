...
- [x] **SPNS-01**: Sponsor showcase with tiered layout (Platinum, Gold, Silver, Community)
- [x] **SPNS-02**: Each sponsor displays logo, short description, and link
- [x] **SPNS-03**: Sponsor data managed via YAML content collection

### Team

- [x] **TEAM-01**: Team page displaying 10-20 members with photo, name, role, social links
- [x] **TEAM-02**: Members grouped by function (core, program committee, volunteers)
- [x] **TEAM-03**: Team data managed via YAML content collection
...
- [x] **EVNT-01**: Post-event mode: countdown switches to "watch replays" with YouTube playlist link
- [x] **EVNT-02**: Schedule talks link to YouTube recordings when available (youtubeUrl field)
- [x] **EVNT-03**: Previous edition section with video recap, photo gallery link, key numbers
- [x] **EVNT-04**: CFP status indicator linking to Conference Hall (open/closed/coming soon)

### SEO & Legal

- [x] **META-01**: SEO meta tags, Open Graph, Twitter cards on all pages
- [x] **META-02**: Sitemap.xml and robots.txt generated
- [x] **META-03**: JSON-LD structured data for Event schema
- [x] **META-04**: hreflang tags for FR/EN pages
- [x] **META-05**: Code of Conduct page
- [x] **META-06**: Privacy policy and terms pages
- [x] **META-07**: Footer with social links (LinkedIn, YouTube, Bluesky, X), association info, legal links
...
| SCHD-01 | Phase 7: Interactive Schedule | Complete |
| SCHD-02 | Phase 7: Interactive Schedule | Complete |
| SCHD-03 | Phase 7: Interactive Schedule | Complete |
...
| SPNS-01 | Phase 5: Sponsors & Team | Complete |
| SPNS-02 | Phase 5: Sponsors & Team | Complete |
| SPNS-03 | Phase 5: Sponsors & Team | Complete |
| TEAM-01 | Phase 5: Sponsors & Team | Complete |
| TEAM-02 | Phase 5: Sponsors & Team | Complete |
| TEAM-03 | Phase 5: Sponsors & Team | Complete |
...
| EVNT-01 | Phase 8: Event Lifecycle | Complete |
| EVNT-02 | Phase 8: Event Lifecycle | Complete |
| EVNT-03 | Phase 6: Venue & Previous Editions | Complete |
| EVNT-04 | Phase 8: Event Lifecycle | Complete |
| META-01 | Phase 9: SEO, Legal & Polish | Complete |
| META-02 | Phase 9: SEO, Legal & Polish | Complete |
| META-03 | Phase 9: SEO, Legal & Polish | Complete |
| META-04 | Phase 9: SEO, Legal & Polish | Complete |
| META-05 | Phase 9: SEO, Legal & Polish | Complete |
| META-06 | Phase 9: SEO, Legal & Polish | Complete |
| META-07 | Phase 9: SEO, Legal & Polish | Complete |
...
- Unmapped: 0
- Complete: 48
- Deferred: 1 (FNDN-07 — cnd-platform repo)
- Pending: 0
